...
if __name__ == "__main__":
    ...
    print()
    print("  CORE TABLES (CMS-mandated summary data):")
    print("  - payers              (insurance companies/plans)")
    print("  - metrics_reports     (annual PA metrics publications)")
    print("  - data_points         (CMS-required headline metrics)")
    print("  - pa_requirements     (services requiring PA)")
    print("  - compliance_checks   (CMS rule compliance tracking)")
    print()
    print("  GRANULAR TABLES (detailed breakdowns when available):")
    print("  - service_level_stats (PA outcomes by service type)")
    print("  - denial_reasons      (why requests were denied)")
    print("  - appeal_outcomes     (what happened on appeal)")
    print("  - diagnosis_pa_volume (which conditions drive PA)")
    print("  - prescriber_stats    (who submits PA requests)")
    print("  - source_files        (evidence chain — original PDFs/URLs)")
    print()
